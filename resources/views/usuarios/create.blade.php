    ...
    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
        <div class="form-group">
            <div class="form-line">
                <!-- <input type="text" id="email_address_2" class="form-control" placeholder="Enter your email address">
                 -->
                 {{Form::text('email',null,['class'=>'form-control ', 'id'=>'email_address_2', 'placeholder'=>'Ingresa un correo'])}}
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
        <div class="form-group">
            <div class="form-line">
                ...
                {{Form::password('password',['class'=>'form-control ', 'id'=>'password_2', 'placeholder'=>'Ingresa una contraseña'])}}
            </div>
        </div>
    </div>
</div>
